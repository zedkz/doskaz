 ...
 */
final class Version20200403094423 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN regional_coordinators.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A5E35D6BA76ED395 ON regional_coordinators (user_id)');
        $this->addSql('ALTER TABLE regional_coordinators ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A5E35D6BA76ED395');
        $this->addSql('DROP INDEX regional_coordinators_pkey');
        $this->addSql('ALTER TABLE regional_coordinators DROP id');
        $this->addSql('ALTER TABLE regional_coordinators ALTER cities TYPE JSONB');
        $this->addSql('ALTER TABLE regional_coordinators ALTER cities DROP DEFAULT');
        $this->addSql('ALTER TABLE regional_coordinators ADD PRIMARY KEY (user_id)');
        $this->addSql('ALTER TABLE adding_requests ALTER data TYPE JSONB');
        $this->addSql('ALTER TABLE adding_requests ALTER data DROP DEFAULT');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file TYPE JSONB');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file DROP DEFAULT');
