<template>
    <div class="popup__wrapper">
        <div class="popup__in --md">
            <nuxt-link :to="{name: 'objects-id', params: {id: $route.params.id}}" class="popup__close"></nuxt-link>
            ...
            <div class="popup__buttons">
                <button type="button" class="popup__button --no" @click.prevent="reject">
                ...
                <button type="button" class="popup__button --yes" @click.prevent="confirm">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
