    ...
    * {
    ...
    .input {
        ...
        &.--search {
            ...
            position: relative;
            background: url('data:image/svg+xml;base64,') right 20px center no-repeat;
        }
    ...
    .add-link {
        ...
        color: #5B6067;
        padding: 0;
        border-bottom: 1px dashed #5B6067;
    }
