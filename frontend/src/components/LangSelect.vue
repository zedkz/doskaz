<template>
  <div class="lang-select">
    <div class="lang-select__selected" @click="selectLang = !selectLang">
      <span>Qaz</span>
      <svg width="8" height="4" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg" class="lang-select__arrow-desktop">
        <path d="M4 4L3.49691e-07 2.54292e-07L8 9.53674e-07L4 4Z" fill="#333333" />
      </svg>
      <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="lang-select__arrow-mobile">
