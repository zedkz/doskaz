		...
		<div class="blog__in">
			<div class="blog__content">
				<div class="blog__inside-content">
					<h3 class="blog__inside-title">Жалоба на отделение банка</h3>
					<p class="blog__inside-text">Каждый гражданин может повлиять на то, чтобы его окружала городская безбарьерная среда. Взывание к совести хозяев объектов, споры, объяснения и скандалы обычно ни к чему не приводят. Самый действенный способ – подача жалобы на недоступный объект в уполномоченный государственный орган. В Казахстане жалобы принимают областные Департаменты Комитета труда, социальной защиты и миграции населения. Данные государственные органы наделены полномочиями выдавать предписание на адаптацию объекта или накладывать административные штрафы за невыполнение предписаний.</p>
					<img class="blog__inside-img" src="./../../assets/img/blog/blog1.jpg"/>
					<p class="blog__inside-text">В январе от команды проекта «Доступный Казахстан» в Департамент Комитета труда, социальной защиты и миграции по Павлодарской области было подано 4 жалобы. Чтобы понять, как это работает, разберем жалобу на филиал Банка Центр Кредит по адресу ул. Торайгырова, 34.</p>
					<p class="blog__inside-text">На объекте имелись нарушения, которые классифицируются как «препятствующие реализации права на доступ к объекту социальной инфраструктуры людям с инвалидностью и другим маломобильным группам населения» согласно Своду правил Республики Казахстан 3.06-101-2012 «Проектирование зданий и сооружений с учетом доступности для маломобильных групп населения. Общие положения»:</p>
					<ul class="blog__inside-list">
						<li class="blog__inside-list-item">площадка на крыльце слишком узкая для разворота на кресле-коляске, ступени имеют высоту более 15 см, уклон пандуса крутой, нет навеса над входной площадкой, воспользоваться банкоматом человеку в кресле-коляске будет сложно, так как под банкоматом нет места для коленей;</li>
						<li class="blog__inside-list-item">в тамбуре сразу начинается внутренняя лестница, при этом нет внутреннего пандуса или внутреннего электрического подъемника, то есть для человека на кресле-коляске отсутствует возможность воспользоваться услугами банка.</li>
					</ul>
					<a href="" class="inside-link">
						<span class="inside-link__img">
					...
					<p class="blog__inside-text">Сотрудник проекта «Доступный Казахстан» выехал на место и зафиксировал текущие адаптационные работы – установлены поручни на наружном пандусе, кнопка вызова персонала, внутри установлен электрический подъемник. Предлагаем вашему вниманию фотографии «до» и «после».</p>
					...
					<h4 class="title --small">Комментарии</h4>
