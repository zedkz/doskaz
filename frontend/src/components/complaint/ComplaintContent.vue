        ...
        <div class="complaint__line complaint__row">
          ...
          >
            ...
            <span class="violations_error" v-if="focus.iin"
              >Поле должно содержать 12 символов</span
            >
          </div>
        </div>
        <div class="complaint__line complaint__row">
      ...
      <div class="complaint__item">
        ...
        >
          <h3 class="title --small">
            Выберите из списка, что именно вас не устроило на объекте
          </h3>
        ...
        >
          <div class="checkbox">
            ...
            />
            <label for="d1"
              >Данными условиями создана угроза причинения вреда моей жизни и
              здоровью (отметить, если это так)</label
            >
          </div>
        </div>
      </div>
