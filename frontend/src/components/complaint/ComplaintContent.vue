                        ...
                        <div class="complaint__row">
                            ...
                            <div class="complaint__accordion-content complaint__col --lg">
                                <div class="checkbox complaint__line --sm" v-for="option in field.options"
                                     :key="option.key">
                                    <input type="checkbox" :id="`option-${field.key}-${option.key}`" v-model="complaint.content.options[option.key]">
                    ...
                    <div class="complaint__col --lg">
                        <div class="photo-input__wrapper">
                            <div class="photo-input" v-for="(photo, index) in photosRaw" :key="index">
                                ...
                                <span v-if="photosPreview[index]" v-bind:style="{ 'background-image': 'url(' + photosPreview[index] + ')' }"></span>
                            </div>
                        </div>
    ...
    const fields = [
        {
            ...
            options: [
                ...
                {key: '8ab4229b-c978-4493-b4c4-a346d57ec03b', label: 'Специальное парковочное место находится далеко от входа'},
                {key: '7752cb1a-365f-4d99-b536-01e3eeddeb3f', label: 'Отсутствие на асфальте специальной разметки со знаком «Инвалид»'},
                {key: 'a5a91cab-807e-4366-b9ec-420fca40a849', label: 'Отсутствие специального знака «Инвалид» рядом с парковочным местом»'},
                {key: '052d6769-dd4f-49eb-a759-349596733089', label: 'Отсутствие бордюрного пандуса'},
                {key: 'cbcba0f9-f5f9-4ee5-95fd-db9f857efdc8', label: 'Наличие высокого бордюра в месте съезда с парковки на тротуар/ бордюрного пандуса'},
            ]
        },
        {
            key: 'inputGroup',
            ...
            options: [
                ...
                {key: '7946cc13-d816-4e1e-b095-21a7d4c17d41', label: 'Вместо пандуса/подъемника установлен швеллер/ колейная аппарель'},
                ...
                {key: '0e4218b0-0e96-4ea6-816e-cc87c528fac2', label: 'Отсутствие тактильной полосы на нижней и верхней ступенях лестницы'},
                {key: '6c675929-1b9f-4b16-83c7-5959f6933da6', label: 'Узкая разворотная площадка (начало, середина, конец пандуса)'},
                ...
                {key: '135ef242-5e6d-47c7-89d3-9c74ab2bd6d0', label: 'Отсутствие контрастной маркировки на входной стеклянной двери'},
        ...
        },
        {
            ...
            options: [
                ...
                {key: 'bb43be62-8457-4ab9-be12-27b0d1e6e092', label: 'Вместо внутреннего пандуса/подъемника установлен швеллер/ колейная аппарель'},
        ...
        },
        {
            ...
            options: [
                {key: 'd45aa08a-f924-4eeb-8319-6a836842daf2', label: 'Слишком низкая/высокая рабочая поверхности стола, стойки'},
                {key: 'a642c676-a789-4ce7-ba17-3d9ffb5332e8', label: 'Отсутствие свободного пространства около мебели'},
                {key: 'ec7393f7-272a-42ed-b0e0-81dc56bfdc23', label: 'Отсутствие доступа к кассовым аппаратам, банкоматам и т.д.'},
                {key: '56590b0a-d6b2-4117-9b4a-22220b441b45', label: 'Отсутствие службы сопровождения (только для вокзалов, аэропортов, поликлиник)'},
                {key: 'a38aeb4f-1c3a-48db-b9e7-9afe24077e3f', label: 'Отсутствие специальных мест в концертных и спортивных залах, на смотровых площадках '},
            ]
        },
        {
            key: 'wc',
            ...
            options: [
                ...
                {key: '4e570daa-d80e-49cf-bc4f-60239c7f440b', label: 'Отсутствие свободного пространства около раковины'},
                {key: '7cb29da0-ea16-468e-94d4-c681dcde194d', label: 'Отсутствие поручней около унитаза'},
                {key: '1750cc2c-9810-4ab7-92d0-59438bd30e87', label: 'Отсутствие свободного пространства рядом с унитазом'},
        ...
        },
        {
            ...
            options: [
                ...
                {key: '4cd729da-ac47-4ae5-8014-a4105bcdc07e', label: 'Отсутствие указателей, в том числе тактильных и/или с использованием шрифта Брайля'},
                {key: 'b117f3d1-e42f-4211-849b-66c9a50d6e2b', label: 'Отсутствие режима работы, расписания, номеров кабинетов и т.д., в том числе тактильных и/или с использованием шрифта Брайля'},
                ...
                {key: '9a64ac67-1180-48fb-9fb9-9f6b98ebaa86', label: 'Отсутствие звукового сопровождения визуальной информации'},
